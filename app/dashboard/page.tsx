...
function UserDashboard() {
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded shadow-lg w-full max-w-6xl">
      {/* Dashboard Header */}
      <div className="text-center mb-8">
        <h1 className="text-5xl font-bold text-blue-700">User Dashboard</h1>
        <p className="mt-2 text-gray-600">
          Manage your messages and settings easily.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <input
            ...
            value={profileUrl}
            disabled
            className="input input-bordered w-full sm:max-w-md p-3"
          />
